...
func HeadObject(w http.ResponseWriter, r *http.Request) {
	...
	// HEAD request should return 200 OK with headers but no body
	w.WriteHeader(http.StatusOK)
}

// HeadObjectRequest represents the S3 HeadObject request
type HeadObjectRequest struct {
	...
	// Request headers
	Headers HeadObjectRequestHeaders
}

// HeadObjectRequestHeaders represents request headers for HeadObject
type HeadObjectRequestHeaders struct {
...
// HeadObjectResponseHeaders represents response headers for HeadObject
type HeadObjectResponseHeaders struct {
